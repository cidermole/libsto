...
struct IndexBuffer {
   ...
   */
  virtual void AddSentence(const Sentence<Token> &sent, sto_updateid_t version) = 0;
...
struct BatchIndexBuffer : public IndexBuffer<Token> {
   ...
   */
  virtual void AddSentence(const Sentence<Token> &sent, sto_updateid_t version) override;
