...
struct sto_updateid_t {
  ...
  constexpr sto_updateid_t() : stream_id(0), sentence_id(0) {}
  constexpr sto_updateid_t(stream_t stream_id, seqid_t sentence_id) : stream_id(stream_id), sentence_id(sentence_id) {}
