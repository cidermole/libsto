...
#    message(WARNING "FindRocksDB: ROCKSDB_LIBRARIES-NOTFOUND ... NAMES ${ROCKSDB_LIBRARY_NAMES} HINTS ${_rocksdb_LIBRARIES_SEARCH_DIRS}")
...
#  else()
#    message(INFO "FindRocksDB: ROCKSDB_LIBRARIES was found")
#    #LOG_LIBRARY(rocksdb "${ROCKSDB_LIBRARIES}")
#  endif()

   # or define BUILD_LINK_SHARED. -David

  # if the include and the program are found then we have it
  if(ROCKSDB_INCLUDE_DIR AND ROCKSDB_LIBRARIES)
    message(INFO "RocksDB headers found at ${ROCKSDB_INCLUDE_DIR}")
